...
\end{tabular}
\caption{CIFAR-10: Best Logistic Regression results per Feature Extraction Method}
\label{tab:cifar_lr}
\end{table}
...
\end{tabular}
\caption{CIFAR-10:  Best Random Forest results per Feature Extraction Method}
\label{tab:cifar_rf}
\end{table}
...
\end{tabular}
\caption{GTSRB:  Best Logistic Regression results per Feature Extraction Method}
\label{tab:gtsrb_lr}
\end{table}
...
\end{tabular}
\caption{GTSRB:  Best Random Forest results per Feature Extraction Method}
\label{tab:gtsrb_rf}
\end{table}
