...
Now, we will just compare all the different algorithms and models applied to each dataset.

\subsubsection{CIFAR-10}

for every algorithm / model, a table with top 3 best models. (so 4 tables with 3 rows each)

and then 1 table, containing best configuration of every algorithm / model (so 1 table with 4 rows)
